...
```bash
$ java -jar target/xdagj-p2p-0.1.5-jar-with-dependencies.jar [options]
$ java -jar target/xdagj-p2p-0.1.5-jar-with-dependencies.jar [options]
```
...
```bash
$ java -jar target/xdagj-p2p-0.1.5-jar-with-dependencies.jar -s 127.0.0.1:16783
```
...
java -jar target/xdagj-p2p-0.1.5-jar-with-dependencies.jar -p 16783 -v 201910292 -d 1 \
...
java -jar target/xdagj-p2p-0.1.5-jar-with-dependencies.jar -p 16783 -v 54321 -d 1 \
-s <SEED_NODE_IP>:16783 \
-publish \
...
The standard dependency JAR (`xdagj-p2p-0.1.5.jar`) contains the core library code, making it suitable for use as a Maven dependency.

...
XDAGJ-P2P v0.1.6 uses **Kademlia DHT** for fully decentralized peer-to-peer discovery via UDP protocol.
...
```bash
# Node 1
java -jar xdagj-p2p-0.1.6-jar-with-dependencies.jar -p 10000 -s 127.0.0.1:10001,127.0.0.1:10002 &

# Node 2
java -jar xdagj-p2p-0.1.6-jar-with-dependencies.jar -p 10001 -s 127.0.0.1:10000,127.0.0.1:10002 &

# Node 3
java -jar xdagj-p2p-0.1.6-jar-with-dependencies.jar -p 10002 -s 127.0.0.1:10000,127.0.0.1:10001 &
```
